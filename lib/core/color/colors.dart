...
class AppColors {
  ...
  static const Color primaryColor = Color.fromARGB(255, 8, 64, 216); // Green
  ...
  static const Color lime = Color(0xFFBFFF00); // Lime
  static const Color violet = Color(0xFF8F00FF); // Violet
  ...
  static const Color navy = Color(0xFF000080); // Navy Blue
}
