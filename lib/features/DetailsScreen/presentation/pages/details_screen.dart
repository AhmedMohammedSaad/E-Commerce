...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
    ...
    return MultiBlocProvider(
      ...
      child: BlocBuilder<ShopCubit, ShopState>(builder: (context, state) {
        ...
        return Scaffold(
          ...
          appBar: appbar(context, widget.products),
          body: Stack(children: [
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: LoveIconButton(
                                index: widget.index,
                                getProductData: widget.products,
                                isFavorte: cubit.chaickIsFavorte(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: StyleTextApp
                            .font14ColorgrayTextDecorationlineThrough,
                      ),
                    ],
                  ),
                ),
  ...
  AppBar appbar(BuildContext context, ProductsShop getproductData) {
    return AppBar(
      leading: IconButton(
          onPressed: () {
      ...
      title: SizedBox(
        ...
        child: Text(
          overflow: TextOverflow.ellipsis,
          getproductData.productName.toString(),
          style: StyleTextApp.font16ColorblacFontWeightBold,
        ),
      ),
      actions: [
